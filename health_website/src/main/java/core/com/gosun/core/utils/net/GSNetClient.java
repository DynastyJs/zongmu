...
//    private 
    ...
    public void init() throws Exception{
        ...
        if(this.ioSession == null || !this.ioSession.isConnected()){
            try{
                  ...
                  this.ioSession = this.connect(connector, new InetSocketAddress(this.getServerIp(),this.getServerPort()));
    ...
    private NioSocketConnector getConnector(){
        ...
        if(this.sendHeartBeat){
             ...
             KeepAliveFilter heartBeat = new KeepAliveFilter(heartBeatFactory,IdleStatus.WRITER_IDLE,KeepAliveRequestTimeoutHandler.DEAF_SPEAKER);
             /** 是否回发 */
        ...
        //创建IoSession重连过滤器
        /*ReconnectionFilter reconnectionFilter = new ReconnectionFilter(this.getRetryInterval(),this.getRetryAttempts());
    ...
    public boolean closeSession(){
    	...
    	if(this.ioSession.getService() != null) this.ioSession.getService().dispose();
    	this.ioSession = null;
