    ...
    statics: {
        generateData: (function() {
            ...
            function getRandom(array) {
                var index = Gsui.Number.randomInt(0, array.length - 1);
                return array[index];
            }
            ...
            return function(total, adults, children) {
                ...
                if (!adultsUndef && !childrenUndef) {
                    ...
                    total = total || 15;
                    if (adultsUndef && childrenUndef) {
                        adults = Gsui.Number.randomInt(Math.floor(total * 0.25), Math.floor(total * 0.75));
                ...
                for (i = 0; i < total; ++i) {
                    ...
                    out.push({
                        ...
                        lastName: name.last,
                        age: i >= adults ? Gsui.Number.randomInt(0, 17) : Gsui.Number.randomInt(18, 100),
