...
Gsui.define('Demo.controller.Direct', {
    extend: 'Gsui.app.Controller',
    
    requires: [
        'Gsui.direct.RemotingProvider',
        'Gsui.direct.Manager',
        'Gsui.app.domain.Direct'
    ],
    
    config: {
        /**
         * @cfg {String} apiUrl
         * Default URL to use for Gsui.Direct service discovery requests.
         */
        apiUrl: 'resources/direct/api.php',
        
        /**
         * @cfg {String} [varName=Gsui.app.REMOTING_API]
         * Default variable name to use for Gsui.Direct API declaration.
         */
        varName: 'Gsui.app.REMOTING_API',
    ...
    onDirectConnect: function(options) {
        ...
        Gsui.direct.Manager.loadProvider(request, me.providerCallback, me);
    },
