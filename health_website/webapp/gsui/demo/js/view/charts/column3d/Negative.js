 ...
 */
Gsui.define('Demo.view.charts.column3d.Negative', {
    extend: 'Gsui.Panel',
    xtype: 'column-negative-3d',
    requires: ['Gsui.chart.theme.Muted','Demo.view.charts.column3d.NegativeController'],
    controller: 'column-negative-3d',
    // <example>
    // Content between example tags is omitted from code preview.
    otherContent: [{
        type: 'Controller',
        path: 'js/view/charts/column3d/NegativeController.js'
    }],
