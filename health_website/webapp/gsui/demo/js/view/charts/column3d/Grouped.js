 ...
 */
Gsui.define('Demo.view.charts.column3d.Grouped', {
    extend: 'Gsui.Panel',
    xtype: 'column-grouped-3d',
    requires: ['Gsui.chart.theme.Muted'],
    ...
    items: [{
        ...
        axes: [{
            ...
            renderer: function (v, layoutContext) {
                ...
                return value === 0 ? '$0' : Gsui.util.Format.number(value, '$0K');
            }
        }, {
            type: 'category3d',
            position: 'bottom',
        ...
        series: {
            ...
            label: {
                ...
                renderer: function (value) {
                    return Gsui.util.Format.number(value / 1000, '$0K');
                }
            },
            highlight: true,
            style: {
        ...
        items: [{
            ...
            columns : {
                defaults: {
                    sortable: false,
                    menuDisabled: true,
                    renderer: function (v) { return Gsui.util.Format.number(v, '$0,000'); }
                },
                items: [
