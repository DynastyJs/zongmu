 ...
 */
Gsui.define('Demo.view.charts.column3d.Basic', {
    extend: 'Gsui.Panel',
    xtype: 'column-basic-3d',
    requires: ['Gsui.chart.theme.Muted','Demo.view.charts.column3d.BasicController'],
    controller: 'column-basic-3d',
    // <example>
    // Content between example tags is omitted from code preview.
    otherContent: [{
        type: 'Controller',
        path: 'js/view/charts/column3d/BasicController.js'
    }],
    ...
    tbar: [
        '->',
        {
            text: Gsui.os.is.Desktop ? 'Download' : 'Preview',
            handler: 'onDownload'
        }
    ],
    ...
    items: {
        ...
        series: [{
            ...
            label: {
                ...
                display: 'insideEnd',
                renderer: function (v) {
                    return Gsui.util.Format.number(v / 1000, '0,000');
                }
            },
            tooltip: {
                trackMouse: true,
                ...
                renderer: function(storeItem, item) {
                    ...
                    Gsui.util.Format.number(storeItem.get('ind'), '0,000 (millions of USD)'));
                }
            }
        }],
        sprites: [{
