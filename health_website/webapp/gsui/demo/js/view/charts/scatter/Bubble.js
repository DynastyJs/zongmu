(function () {
    /**
     * Demonstrates how to make a bubble chart using Gsui.chart.series.Scatter
     *
     ...
     */
    Gsui.define('Demo.view.charts.scatter.Bubble', {
        extend: 'Gsui.Panel',
        ...
        requires: [
            ...
            'Gsui.chart.series.Scatter',
            'Gsui.chart.axis.Numeric',
            'Gsui.chart.interactions.*'
        ],
        ...
        tbar: [
            '->',
            {
                ...
                handler: function () {
                    ...
                    fromHSL = Gsui.draw.Color.fly('blue').getHSL();
            ...
            },
            {
                ...
                handler: function () {
                    ...
                    fromHSL = Gsui.draw.Color.fly('cyan').getHSL();
        ...
        constructor: function(config) {
            ...
            fromHSL = Gsui.draw.Color.fly('blue').getHSL();
            toHSL = Gsui.draw.Color.fly('red').getHSL();
            fromHSL[2] = 0.3;
        }
    });
    ...
    function interpolateColor(lambda, minSrc, maxSrc) {
        return Gsui.draw.Color.fly(0, 0, 0, 0).setHSL(
