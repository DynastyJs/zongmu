 ...
 */
Gsui.define('Demo.view.charts.combination.Dashboard', {
    ...
    initComponent: function() {
        ...
        for (var i = 0, l = myData.length, rand = Math.random; i < l; i++) {
            var data = myData[i];
            data[1] = Gsui.util.Format.number(((rand() * 10000) >> 0) / 100, "0");
        ...
        var ds = Gsui.create('Gsui.data.ArrayStore', {
            fields: [
                {name: 'name' },
        ...
        // create radar store.
        var radarStore = Gsui.create('Gsui.data.JsonStore', {
            fields: ['Name', 'Data'],
            data: [
                { 'Name': 'Price', 'Data': 100 },
        ...
        var radarChart = Gsui.create('Gsui.chart.PolarChart', {
            margin: '0 0 0 0',
            width: 200,
            store: radarStore,
            theme: 'Blue',
        ...
        var gridPanel = Gsui.create('Gsui.grid.Panel', {
            id: 'company-form',
            flex: 6,
            store: ds,
            defaults: {
        ...
        var barChart = Gsui.create('Gsui.chart.CartesianChart', {
            height: 250,
            flex: 1,
            margin: '0 0 3 0',
            ...
            axes: [{
                ...
                label: {
                    renderer: function(v) {
                        return Gsui.String.ellipsis(v, 15, false);
                    },
                    font: '11px Arial',
                    rotate: {
                        degrees: -45
