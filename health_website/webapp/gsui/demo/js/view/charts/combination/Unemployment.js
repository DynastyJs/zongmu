 ...
 *
 */
Gsui.define('Demo.view.charts.combination.Unemployment', {
    extend: 'Gsui.panel.Panel',
    xtype: 'unemployment',

    requires: ['Demo.view.charts.combination.ArcText'],
            ...
            series: [
                {
                    ...
                    renderer: function (sprite, config, data, index) {
                        // Please see the comments in the Demo.store.Unemployment class
