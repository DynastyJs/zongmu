 ...
 */
Gsui.define('Demo.view.charts.other.TipCharts', {
    extend: 'Gsui.Panel',
    xtype: 'tip-chart',
    ...
    initComponent: function() {
        ...
        me.dockedItems = [{
                ...
                '->',
            {
                text: 'Save Chart',
                handler: function() {
                    Gsui.MessageBox.confirm('Confirm Download', 'Would you like to download the chart as an image?', function(choice){
                        if(choice == 'yes'){
        ...
        me.tipStore = Gsui.create('Gsui.data.JsonStore', {
            fields: ['browser', 'data' ],
            data: [
                { browser: 'IE', data: 0 },
        ...
        me.smartTip = Gsui.create('Gsui.tip.ToolTip', {
            trackMouse: true,
            width: 400,
            height: 180,
            dismissDelay: 0,
