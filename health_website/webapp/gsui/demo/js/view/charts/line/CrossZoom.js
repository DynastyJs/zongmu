 ...
 */
Gsui.define('Demo.view.charts.line.CrossZoom', {
    extend: 'Gsui.Panel',
    ...
    requires: [
        ...
        'Gsui.chart.interactions.CrossZoom'
    ],
    ...
    tbar: [
        '->',
        {
            text: 'Undo Zoom',
            handler: function() {
                var chart = Gsui.getCmp('usd2eur-chart'),
                    interaction = chart && Gsui.ComponentQuery.query('interaction', chart)[0],
