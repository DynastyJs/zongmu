 ...
 */
Gsui.define('Demo.view.charts.bar3d.Negative', {
    extend: 'Gsui.Panel',
    xtype: 'bar-negative-3d',
    requires: ['Gsui.chart.theme.Muted','Demo.view.charts.bar3d.NegativeController'],
    controller: 'bar-negative-3d',
    // <example>
    // Content between example tags is omitted from code preview.
    otherContent: [{
        type: 'Controller',
        path: 'js/view/charts/bar3d/NegativeController.js'
    }],
