            ...
            updaters: {
                ...
                recalculate: function (attr) {
                    ...
                    var alpha = Math.atan2(dy, dx),
                        ...
                        mat = Gsui.draw.Matrix.fly([cos(alpha), sin(alpha), -sin(alpha), cos(alpha), toX, toY]),
                        angleArrowThreshold = Gsui.draw.Draw.radian * me.getAngleArrowThreshold(),
                    ...
                    mat = Gsui.draw.Matrix.fly([cos(theta), sin(theta), -sin(theta), cos(theta), ax, ay]);
