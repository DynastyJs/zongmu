 ...
 */
Gsui.define('Demo.view.draw.FreeDrawComponent', function () {
    ...
    function smoothList(points) {
        ...
        dx = Gsui.draw.Draw.spline(dx);
        dy = Gsui.draw.Draw.spline(dy);
        ...
        listeners: {
            ...
            mousedown: function(e) {
                var targetElement = this,
                    me = Gsui.getCmp(targetElement.id),
                ...
                if (!me.sprite) {
                    ...
                    me.sprite = surface.add({
                        ...
                        lineCap: 'round',
                        lineJoin: 'round',
                        strokeStyle: new Gsui.draw.Color(Math.random() * 127 + 128, Math.random() * 127 + 128, Math.random() * 127 + 128)
                    });
                    surface.renderFrame();
                }
            },
            mousemove: function(e) {
                ...
                if (me.sprite) {
                    ...
                    if (Gsui.os.is.Android) {
                        Gsui.draw.Animator.schedule(function () {
                            surface.renderFrame();
                        }, me);
                    } else {
                        surface.renderFrame();
