...
Gsui.define('Demo.view.grid.Paging', {
    ...
    requires: [
        ...
        'Gsui.util.*',
        'Gsui.toolbar.Paging',
       // 'Gsui.ux.PreviewPlugin',
        'Demo.model.grid.ForumThread'
    ],
    xtype: 'paging-grid',
    ...
    otherContent: [{
        type: 'Store',
        path: 'js/store/ForumThreads.js'
    },{
        type: 'Model',
        path: 'js/model/grid/ForumThread.js'
    }],
    themes: {
        classic: {
            width: 700,
    ...
    initComponent: function(){
        ...
        var store = Gsui.create('Demo.store.ForumThreads');
    ...
    renderLast: function(value, p, model) {
        return Gsui.String.format('{0}<br/>by {1}', Gsui.Date.dateFormat(value, 'M j, Y, g:i a'), model.get('lastposter'));
    }
});
