 ...
 * reconfigure method.
 */
Gsui.define('Demo.view.grid.Reconfigure', {
    ...
    requires: [
        ...
        'Demo.model.grid.Office',
        'Demo.model.grid.Employee'
    ], 
    ...
    createOfficeStore: function(){
        ...
        for (; i < 7; ++i) {
            data.push({
                ...
                totalEmployees: Gsui.Number.randomInt(10, 25)
            });
        }
        return new Gsui.data.Store({
            model: Demo.model.grid.Office,
            data: data
        });
    },
    ...
    generateName: function(){
        var lasts = this.lastNames,
            ...
            getRandomInt = Gsui.Number.randomInt,
    ...
    getCity: function(){
        ...
        return cities[Gsui.Number.randomInt(0, len - 1)];
    },
    ...
    getDepartment: function() {
        ...
        return departments[Gsui.Number.randomInt(0, len - 1)];
    }
});