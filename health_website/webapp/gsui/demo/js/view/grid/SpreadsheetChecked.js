 ...
 */
Gsui.define('Demo.view.grid.SpreadsheetChecked', {
    extend: 'Gsui.grid.Panel',
    requires: [
        'Gsui.grid.selection.SpreadsheetModel',
        'Gsui.grid.plugin.Clipboard',
        'Demo.store.grid.MonthlySales',
        'Demo.view.grid.SpreadsheetController'
    ],
    //<example>
    exampleTitle: 'Spreadsheet',
    otherContent: [{
        type: 'Controller',
        path: 'js/view/grid/SpreadsheetController.js'
    },{
        type: 'Store',
        path: 'js/store/grid/MonthlySales.js'
    },{
        type: 'Model',
        path: 'js/model/grid/MonthlySales.js'
    }],
    //</example>
