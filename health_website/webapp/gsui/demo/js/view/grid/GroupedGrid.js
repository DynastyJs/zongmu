 ...
 */
Gsui.define('Demo.view.grid.GroupedGrid', {
    extend: 'Gsui.grid.Panel',
    xtype: 'grouped-grid',
    requires: [
        'Gsui.grid.feature.Grouping'
    ],
    collapsible: true,
    iconCls: 'icon-grid',
    frame: true,
    ...
    otherContent: [{
        type: 'Store',
        path: 'js/store/Restaurants.js'
    },{
        type: 'Model',
        path: 'js/model/Restaurant.js'
    }],
    themes: {
        classic: {
        },
    ...
    initComponent: function() {
        this.store = new Demo.store.Restaurants();
        this.columns = [{
            text: 'Name',
            flex: 1,
            dataIndex: 'name'
