...
Gsui.define('Demo.view.grid.BigData', {
    extend: 'Gsui.grid.Panel',
    requires: ['Gsui.grid.filters.Filters','Demo.view.grid.BigDataController'],
    xtype: 'big-data-grid',
    store: 'BigData',
    columnLines: true,
    height: 400,
    ...
    otherContent: [{
        type: 'Controller',
        path: 'js/view/grid/BigDataController.js'
    },{
        type: 'Store',
        path: 'js/store/BigData.js'
    },{
        type: 'Model',
        path: 'js/model/grid/Employee.js'
    }],
    exampleDescription: [
    ...
    columns:[{
        ...
        editor: {
            ...
            initComponent: function() {
                ...
                Gsui.form.field.ComboBox.prototype.initComponent.apply(this, arguments);
            }
        }
    }, {
        text: 'Email address',
