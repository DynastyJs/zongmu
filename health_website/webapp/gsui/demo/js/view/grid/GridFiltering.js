 ...
 */
Gsui.define('Demo.view.grid.GridFiltering', {
    extend: 'Gsui.grid.Panel',
    xtype: 'grid-filtering',
    requires: [
        'Gsui.grid.filters.Filters',
        'Demo.store.Products'
    ],
    ...
    otherContent: [{
        type: 'Store',
        path: 'js/store/Products.js'
    },{
        type: 'Model',
        path: 'js/model/grid/Product.js'
    }],
    ...
    onShowFilters: function () {
        ...
        data = Gsui.JSON.encodeValue(data, '\n').replace(/^[ ]+/gm, function (s) {
        ...
        Gsui.Msg.alert('Filter Data', data);
    }
});
