 ...
 */
Gsui.define('Demo.view.tree.TreeGrid', {
    ...
    initComponent: function() {
        ...
        Gsui.apply(this, {
            ...
            columns: [{
                ...
                tpl: Gsui.create('Gsui.XTemplate', '{duration:this.formatHours}', {
                ...
                handler: function(grid, rowIndex, colIndex, actionItem, event, record, row) {
                    Gsui.Msg.alert('Editing' + (record.get('done') ? ' completed task' : '') , record.get('task'));
                },
