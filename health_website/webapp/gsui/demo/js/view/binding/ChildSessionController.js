...
Gsui.define('Demo.view.binding.ChildSessionController', {
    ...
    onSessionChangeClick: function () {
        ...
        if (changes !== null) {
            ...
            Gsui.Msg.alert('No Changes', 'There are no changes to the session.');
        }
    },
    ...
    onCancelClick: function () {
        this.dialog = Gsui.destroy(this.dialog);
    },
