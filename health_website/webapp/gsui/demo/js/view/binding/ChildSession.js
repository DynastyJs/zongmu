 ...
 */
Gsui.define('Demo.view.binding.ChildSession', {
    extend: 'Gsui.panel.Panel',
    xtype: 'binding-child-session',
    //<example>
    requires: [
        'Demo.view.binding.ChildSessionModel',
        'Demo.view.binding.ChildSessionController',
        'Gsui.grid.Panel'
    ],
    otherContent: [{
        type: 'ViewModel',
        path: 'js/view/binding/ChildSessionModel.js'
    }, {
        type: 'ViewController',
        path: 'js/view/binding/ChildSessionController.js'
    }, {
        type: 'View',
        path: 'js/view/binding/ChildSessionForm.js'
    }, {
        type: 'Model',
