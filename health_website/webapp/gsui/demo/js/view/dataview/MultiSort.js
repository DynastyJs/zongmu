 ...
 * field.
 */
Gsui.define('Demo.view.dataview.MultiSort', {
    extend: 'Gsui.panel.Panel',

    requires: [
        'Gsui.toolbar.TextItem',
        'Gsui.view.View',
        'Gsui.ux.DataView.Animated'
    ],
    ...
    otherContent: [{
        type: 'Button View',
        path: 'js/view/dataview/MultiSortButton.js'
    },{
        type: 'Data',
    ...
    initComponent: function() {
        ...
        this.items = {
            ...
            plugins: {
                xclass: 'Gsui.ux.DataView.Animated'
            },
            itemSelector: 'div.dataview-multisort-item',
            store: Gsui.create('Gsui.data.Store', {
                autoLoad: true,
                sortOnLoad: true,
    ...
    /**
     * Returns the array of Gsui.util.Sorters defined by the current toolbar button order
     * @return {Array} The sorters
     */
    getSorters: function() {
        var buttons = this.query('toolbar dataview-multisort-sortbutton'),
            sorters = [];
        Gsui.Array.each(buttons, function(button) {
            sorters.push({
