/**
 * Demonstrates the functionality of the Gsui.window.MessageBox class.
 */
Gsui.define('Demo.view.window.MessageBox', {
    extend: 'Gsui.panel.Panel',
    xtype: 'message-box',
	requires : ['Demo.view.window.MessageBoxController'],
    
    //<example>
    exampleTitle: 'Message Box',
    otherContent: [{
        type: 'ViewController',
        path: 'js/view/window/MessageBoxController.js'
    }],
    //</example>
    layout: {
        type: 'vbox',
