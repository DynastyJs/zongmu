 ...
 */
Gsui.define('Demo.view.toolbar.Breadcrumb', {
    ...
    initComponent: function() {
        var store = new Demo.store.Files();

        this.width = this.themeInfo.width;

        //<example>
        // TODO: when using Demo.store.Files(), nodes with children (e.g. app, or button)
        ...
        this.tbar = [{
            ...
            store: store,
            showIcons: true,
            // Start with "Gsui > dd > DragZone.js" selected
