 ...
 * valid.
 */
Gsui.define('Demo.view.form.CustomErrorHandling', {
    ...
    //<example>
    requires: [
        'Demo.view.form.CustomErrorHandlingController'
    ],
    
    exampleTitle: 'Custom Error Handling',
    otherContent: [{
        type: 'ViewController',
        path: 'js/view/form/CustomErrorHandlingController.js'
    }],
    //</example>
    ...
    dockedItems: [{
        cls: Gsui.baseCSSPrefix + 'dd-drop-ok',
        xtype: 'container',
        dock: 'bottom',
        layout: {
            type: 'hbox',
        ...
        items: [{
            ...
            height: '100%',
            invalidCls: Gsui.baseCSSPrefix + 'form-invalid-icon-default',
            validCls: Gsui.baseCSSPrefix + 'dd-drop-icon',
            ...
            tipTpl: [
                '<ul class="' + Gsui.baseCSSPrefix + 'list-plain">',
                    '<tpl for=".">',
            ...
            setErrors: function(errors) {
                ...
                if (!me.tipTpl.isTemplate) {
                    tpl = me.tipTpl = new Gsui.XTemplate(tpl);
                }
                
                if (!tip) {
                    tip = me.tip = Gsui.widget('tooltip', {
                        target: me.el,
                        title: 'Error Details:',
                        minWidth: 200,
                        autoHide: false,
