/**
 * This example demonstrates use of Gsui.form.field.File, a file upload field with custom
 * rendering, and error handling.
 */
Gsui.define('Demo.view.form.FileUploads', {
    ...
    //<example>
    requires: [
        'Demo.view.form.FileUploadsController'
    ],
    
    exampleTitle: 'File Upload fields',
    otherContent: [{
        type: 'ViewController',
        path: 'js/view/form/FileUploadsController.js'
    }],
    //</example>
    ...
    items: [{
        ...
        items: [{
            ...
            html: [
                ...
                'standard <tt>Gsui.form.field.Field</tt> interface or by handling ',
