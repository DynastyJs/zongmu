 ...
 * dynamic form.
 */
Gsui.define('Demo.view.form.XmlForm', {
    ...
    requires: [
        ...
        'Demo.model.form.Contact',
        'Demo.model.form.FieldError',
        'Demo.view.form.XmlFormController'
    ],
    
    exampleTitle: 'XML Form',
    otherContent: [{
        type: 'Contact Model',
        path: 'js/model/form/Contact.js'
    }, {
        type: 'FieldError Model',
        path: 'js/model/form/FieldError.js'
    }, {
        type: 'Store',
        path: 'js/store/States.js'
    }, {
        type: 'ViewController',
        path: 'js/view/form/XmlFormController.js'
    }, {
        type: 'Load XML',
    ...
    errorReader: {
        type: 'xml',
        model: 'Demo.model.form.FieldError',
        record : 'field',
        successProperty: '@success'
    },
