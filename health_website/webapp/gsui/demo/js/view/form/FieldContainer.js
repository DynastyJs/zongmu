 ...
 * item does not.
 */
Gsui.define('Demo.view.form.FieldContainer', {
    ...
    requires: [
        ...
        'Demo.view.form.FieldContainerController'
    ],

    exampleTitle: 'Field Container',
    otherContent: [{
        type: 'Model',
        path: 'js/model/PartTimeEmployee.js'
    }, {
        type: 'ViewController',
        path: 'js/view/form/FieldContainerController.js'
    }],
    //</example>
