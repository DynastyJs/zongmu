 ...
 */
Gsui.define('Demo.view.form.Checkout', {
    ...
    initComponent: function(){
        var states = new Gsui.data.Store({
            ...
            data: Demo.data.DataSets.states
        }),
        billingStates = new Gsui.data.Store({
            model: Demo.model.State,
            proxy: {
                type: 'memory',
                reader: {
        ...
        if (!this.monthStore) {
            this.self.prototype.monthStore = new Gsui.data.Store({
                fields: ['name', 'num'],
                data: (function() {
                    var data = new Array(12);
                        Gsui.Array.forEach(Gsui.Date.monthNames, function(name, i) {
        ...
        Gsui.apply(this, {
            ...
            fieldDefaults: {
                ...
                msgTarget: Gsui.supports.Touch ? 'side' : 'qtip'
            },
    ...
    onCompleteClick: function(){
        ...
        if (form.isValid()) {
            Gsui.MessageBox.alert('Submitted Values', form.getValues(true));
        }
    },
    ...
    onSameAddressChange: function(box, checked){
        ...
        Gsui.Array.forEach(fieldset.previousSibling().query('textfield'), this.onMailingAddrFieldChange, this);
        Gsui.Array.forEach(fieldset.query('textfield'), function(field) {
