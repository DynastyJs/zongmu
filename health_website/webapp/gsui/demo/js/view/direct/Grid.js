/**
 * This example shows how to use a Grid with a back end Store via Gsui.Direct proxy.
 *
 ...
 */
Gsui.define('Demo.view.direct.Grid', {
    extend: 'Gsui.grid.Panel',
    xtype: 'direct-grid',
    controller: 'directgrid',
    
    requires: [
        'Demo.view.direct.GridController'
    ],
    
    //<example>
    exampleTitle: 'Grid with Gsui.Direct back end',
    exampleDescription: [
    ...
    otherContent: [{
        type: 'ViewController',
        path: 'js/view/direct/GridController.js'
    }, {
    ...
    columns: [{
        ...
        width: 140,
        text: 'Annual revenue',
        renderer: Gsui.util.Format.usMoney
    }],
