 ...
 */
Gsui.define('Demo.view.direct.DirectVC', {
    ...
    /**
     * This method will be called when Gsui.Direct API is initialized;
     * derived ViewControllers should override it to finish initialization.
     * @template
     * @protected
     */
    finishInit: Gsui.emptyFn,
    
    onProviderInit: function(requestUrl, hasProvider) {
        var me = this;
        
        // "Our" part of Gsui.Direct API has been loaded and initialized
    ...
    onProviderFail: function(requestUrl, error) {
        Gsui.Msg.alert('Gsui.Direct init failure', error);
    },
