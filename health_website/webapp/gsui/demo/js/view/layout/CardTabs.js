Gsui.define('Demo.view.layout.CardTabs', {
    extend: 'Gsui.tab.Panel',
    requires: [
        'Gsui.layout.container.Card'
    ],
    ...
    items:[
        {
            title: 'Tab 1',
            html:   'Note that the Gsui.tab.Panel (TabPanel) component uses an internal CardLayout -- it is not ' +
