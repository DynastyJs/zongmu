 ...
 */
Gsui.define('Gsui.sparkline.Bullet', {
    ...
    config: {
        ...
        tipTpl: new Gsui.XTemplate('{fieldkey:this.fields} - {value}', {
            fields: function(v) {
                if (v === 'r') {
                    return 'Range';
                }
    ...
    applyValues: function(newValues) {
        newValues = Gsui.Array.map(Gsui.Array.from(newValues), this.normalizeValue);
