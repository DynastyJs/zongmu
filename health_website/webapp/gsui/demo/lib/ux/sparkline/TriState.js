 ...
 */
Gsui.define('Gsui.sparkline.TriState', {
    ...
    config: {
        ...
        tipTpl: new Gsui.XTemplate('&#9679; {value:this.states}', {
            states: function(v) {
                var value = Number(v);
                if (value === -1) {
                    return 'Loss';
    ...
    applyValues: function(newValues) {
        newValues = Gsui.Array.map(Gsui.Array.from(newValues), Number);
