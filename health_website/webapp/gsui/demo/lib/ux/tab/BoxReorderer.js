/**
 * Base class from Gsui.ux.TabReorderer.
 */
Gsui.define('Gsui.ux.tab.BoxReorderer', {
    requires: [
        'Gsui.dd.DD'
    ],

    mixins: {
        observable: 'Gsui.util.Observable'
    },

    /**
     * @cfg {String} itemSelector
     * A {@link Gsui.DomQuery DomQuery} selector which identifies the encapsulating elements of child
     ...
     * @param {Gsui.ux.BoxReorderer} this
     * @param {Gsui.container.Container} container The owning Container
     * @param {Gsui.Component} dragCmp The Component being dragged
     ...
     * @param {Gsui.ux.BoxReorderer} this
     * @param {Gsui.container.Container} container The owning Container
     * @param {Gsui.Component} dragCmp The Component being dropped
     * @param {Number} startIdx The index position from which the Component was initially dragged.
    ...
    onBoxReady: function() {
        ...
        dd = me.dd = new Gsui.dd.DD(layout.innerCt, me.container.id + '-reorderer');
        Gsui.apply(dd, {
            animate: me.animate,
            reorderer: me,
            container: me.container,
            getDragCmp: me.getDragCmp,
            clickValidator: Gsui.Function.createInterceptor(dd.clickValidator, me.clickValidator, me, false),
    ...
    startDrag: function() {
        ...
        if (dragCmp) {
            ...
            dragCmp.setPosition = Gsui.emptyFn;
    ...
    endDrag: function(e) {
        ...
        if (me.dragCmp) {
            ...
            temp = Gsui.fx.Manager.getFxQueue(me.dragCmp.el.id)[0];
            if (temp) {
                temp.on({
            ...
            // If not animated, clean up after the mouseup has happened so that we don't click the thing being dragged
                ...
                Gsui.Function.defer(me.reorderer.afterBoxReflow, 1, me);
            }
    ...
    getNewIndex: function(pointerPos) {
        var me = this,
            dragEl = me.getDragEl(),
            dragBox = Gsui.fly(dragEl).getBox(),
            targetEl,
            targetBox,
            targetMidpoint,
            i = 0,
