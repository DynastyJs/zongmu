 ...
 */
Gsui.define('Gsui.ux.tab.TabReorderer', {

    extend: 'Gsui.ux.tab.BoxReorderer',
    alias: 'plugin.tabreorderer',

    itemSelector: '.' + Gsui.baseCSSPrefix + 'tab',
    ...
    init: function(tabPanel) {
        ...
        tabPanel.onAdd = Gsui.Function.createSequence(tabPanel.onAdd, me.onAdd);
    },
    ...
    afterBoxReflow: function() {
        ...
        // Cannot use callParent, this is not called in the scope of this plugin, but that of its Gsui.dd.DD object
        Gsui.ux.tab.BoxReorderer.prototype.afterBoxReflow.apply(me, arguments);
