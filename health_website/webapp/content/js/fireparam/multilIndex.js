 ...
 * 显示设备各回路名称
 */
function setPathName(equipmentId){
	$.ajax({
		async:true,
...
var validator = {
		...
		verify:function(){
		    $('#ajaxForm').validator({
		        fields: {
		            '0446301001': 'number;range[300~1000];digits;',
		            '0446302001': 'number;range[0.1~60];decimal',
		            '0446306001': 'number;range[45~110];decimal',
		            '0446307001': 'number;range[0.1~60];decimal',
		            '0446301002': 'number;range[300~1000];digits;',
		            '0446302002': 'number;range[0.1~60];decimal',
		            '0446306002': 'number;range[45~110];decimal',
		            '0446307002': 'number;range[0.1~60];decimal',
		            '0446301003': 'number;range[300~1000];digits;',
		            '0446302003': 'number;range[0.1~60];decimal',
		            '0446306003': 'number;range[45~110];decimal',
		            '0446307003': 'number;range[0.1~60];decimal',
		            '0446301004': 'number;range[300~1000];digits;',
		            '0446302004': 'number;range[0.1~60];decimal',
		            '0446306004': 'number;range[45~110];decimal',
		            '0446307004': 'number;range[0.1~60];decimal',
		            '0446301005': 'number;range[300~1000];digits;',
		            '0446302005': 'number;range[0.1~60];decimal',
		            '0446306005': 'number;range[45~110];decimal',
		            '0446307005': 'number;range[0.1~60];decimal',
		            '0446301006': 'number;range[300~1000];digits;',
		            '0446302006': 'number;range[0.1~60];decimal',
		            '0446306006': 'number;range[45~110];decimal',
		            '0446307006': 'number;range[0.1~60];decimal',
		            '0446301007': 'number;range[300~1000];digits;',
		            '0446302007': 'number;range[0.1~60];decimal',
		            '0446306007': 'number;range[45~110];decimal',
		            '0446307007': 'number;range[0.1~60];decimal',
		            '0446301008': 'number;range[300~1000];digits;',
		            '0446302008': 'number;range[0.1~60];decimal',
		            '0446306008': 'number;range[45~110];decimal',
		            '0446307008': 'number;range[0.1~60];decimal',
		        },
