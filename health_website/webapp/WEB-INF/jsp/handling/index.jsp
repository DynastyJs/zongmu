...
<body> 
	...
	<div class="main-container" id="user-index-layout">
		...
		<div class="orgmgr-table">
			<div class="orgmgr-tool">
				<span class="tool-title">处理中报警事件列表</span>
				<button id="exportBtn" class="btn btn-dodgerblue flat-btn" type="button" data-rightcode="ALARM_HANDING_EXPORT" style="display:none">导出</button>
			...
			<table id="bootstrapTable" class="table" data-pagination="true" >
				<thead>
					<tr>
						...
						<th data-field="beginTimeStr" data-formatter ="alarmCountFormater">报警时间</th>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/content/js/handling/index.js"></script>
