...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/content/js/logging/loginLog.js"></script>
<script type="text/javascript"
						...
						<div class="navbar-form navbar-left" role="form"
							...
							<div class="form-group">
								<div class="input-group">
									...
									<input class="form-control" id="userName" placeholder="用户">
								</div>
							</div>
							<div class="form-group">
								<div class="input-group">
				...
				<table id="bootstrapTable" class="table table-bordered"
					...
					<thead>
						<tr>
							...
							<th data-field="logTime" data-formatter="DateFormatter">时间</th>
						</tr>
					</thead>
				</table>
