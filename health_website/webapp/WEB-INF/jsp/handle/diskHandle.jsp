    ...
    <div id="maskwin"  class="thumbnail"  style="padding-left: 23px;font-size: 14px;border: 0;border-bottom: 1px solid #dedede;">
         <table>
			<tr>
				...
				<td>
			       <div id="right_side"  data-rightcode="SYSDEV_PANGLU" style="display:none;bottom: 4px;">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/content/js/handle/diskHandle.js"></script>
</html>
