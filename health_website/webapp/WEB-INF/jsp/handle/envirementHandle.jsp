			...
			<tr>
				...
				<td>
			       <div id="right_side"  data-rightcode="SYSDEV_PANGLU" style="display:none;bottom: 3px;">
				        ...
				        <button id="maskBtn" class="btn btn-dodgerblue flat-btn" style="width:80px;margin-top: -5px;"  type="button">设置旁路</button>
				        <button id="unmaskBtn" class="btn btn-dodgerblue flat-btn" style="width:80px;margin-top: -5px;" type="button">取消旁路</button>
			        </div>
				</td>
			</tr>
		</table>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/content/js/handle/envirementHandle.js"></script>
</html>
