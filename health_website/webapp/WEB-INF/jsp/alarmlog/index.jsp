...
<body> 
	...
	<div class="main-container" id="user-index-layout">
		...
		<div class="orgmgr-table">
			<div class="orgmgr-tool">
				<span class="tool-title">报警日志列表</span>
				<button id="exportBtn" class="btn btn-dodgerblue flat-btn" type="button" data-rightcode="ALARMLOG_EXPORT" style="display:none">导出</button>
			...
			<table id="bootstrapTable" class="table" data-pagination="true">
				<thead>
					<tr>
						<th data-field="id" data-formatter="numberFormatter" data-width="30">序号</th>
						<th data-field="focusFlag"  data-formatter="focusFormater" data-width="30">关注</th>
						<th data-field="orginizeName" data-width="60">组织机构</th>
						<th data-field="name" data-width="60">设备名称</th>
						<th data-field="equipmentName" data-width="60">设备类型</th>
						<th data-field="producer" data-width="60">设备品牌</th>
						<th data-field="moduleName" data-width="60">设备型号</th>
						<th data-field="netAddress" data-width="60">IP地址</th>					
						<th data-field="propertyName" data-width="60">检测属性</th>
						<th data-field="alarmLevel" data-width="60">报警级别</th>
						<th data-field="alarmType" data-width="60">事件类型</th>						
						<th data-field="alarmDesc" data-width="60">报警描述</th>		
						<th data-field="propertyValue" data-formatter="propertyValueFormater" data-width="60">检测值</th>											
						<th data-field="beginTimeStr" data-width="60">报警时间</th>	
						<th data-field="processTimeStr" data-formatter="autoRecovFormaterTime" data-width="60">处置时间</th>
						<th data-field="processUser" data-formatter="autoRecovFormater" data-width="60">处置人</th>
						<th data-field="processResult" data-formatter="autoRecovFormater" data-width="60">处置结果</th>
						<th data-field="processDesc" data-formatter="autoRecovFormater" data-width="60">回复内容</th>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/content/js/alarmlog/index.js"></script>
