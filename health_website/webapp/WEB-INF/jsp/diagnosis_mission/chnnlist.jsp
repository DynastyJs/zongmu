                    	...
                    	<div class="orgmgr-tool">
                            ...
                            <div class="col-xs-8">
                                <div class="input-group">
                                    <input id="condition" style="width:100%" type="text" placeholder="设备名称/摄像机名称/机构名称/IP地址">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default-gray" style="height:25px;margin-top:0px;" id="search" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                    </span>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="pull-right">
                                    ...
                                    <a title="编辑"  class="btn btn-default btn-sm" id="btnModify" href="javascript:void(0)"><span class="glyphicon glyphicon-pencil"></span></a>
                                </div>
                            </div>
                        </div>
                        </div>
