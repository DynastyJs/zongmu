  ...
  <tr>
    <td valign="top" class="bs-con-main"  ms-controller="AxVideoHomeVideo">
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="top">
            <div class="xm-center" style="padding-right:0px;width:100%;">
				<div class="xm-vido">
		                ...
		                <div id="playBackContainer" class="xm-vido16">
		                    ...
		                    <div class="" style="height: 100%;">
		                        <div class="xm-vido16-child-pc selected">
		                        	<object id="realPlayPanel_1" objIndex="1" width="100%" height="100%" classid="CLSID:DED4CA89-1B4B-4ED3-8B3A-6F579F8733B3" onerror="NotInstall()"></object>
		                        </div>
		                    </div>
		                    <!--播放窗口 end-->
		                </div>
		            ...
		            <div class="xm-vido-b">
		                <div style="height:18px;">
		                    <div>
		                        <div  style="width:100%;margin-top:2px;"></div>
		                    </div>
		                </div>
		                <div class="row xm-row">
		                    <div class="col-xs-8">
	                            ...
	                            <li class="xm-nav-pills-play" ms-if="PlayState!=1"><a href="#" ms-click="Play" title="播放" id="play"><img src="${pageContext.request.contextPath}/content/js/activex/img/glyphicon-play.png"></a></li>
	                            ...
	                            <li><span class="xm-nav-pills-border"></span></li>
		                        <li>
	                                <a href="#" style="padding-top:5px" ms-click="SetVolumeCalm">
	                                    <img ms-if="!IsCalm" src="${pageContext.request.contextPath}/content/js/activex/img/glyphicon-volume-up.png">
	                                    <img ms-if="IsCalm" src="${pageContext.request.contextPath}/content/js/activex/img/glyphicon-volume-off.png">
	                                </a>
	                            </li>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/content/js/record/realtime.js"></script>
	<script for="realPlayPanel_1" event="VGSII_ActiveX_OnMouseEvent(eventInfo)" language="javascript">
	    VGSII_ActiveX_EventCallBackProcess(realPlayPanel_1, eventInfo);
	</script>
		
	<script for="realPlayPanel_1" event="VGSII_ActiveX_OnStreamStatusNotify(streamStatusInfo)" language="javascript">
	    VGSII_ActiveX_StreamStatusNotify(realPlayPanel_1, streamStatusInfo);
	</script>
